...
#ifndef __di_point_h__
#define __di_point_h__
...
#ifndef __Point_DISPINTERFACE_DEFINED__
#define __Point_DISPINTERFACE_DEFINED__

/* dispinterface Point */
/* [helpstring][uuid] */ 


EXTERN_C const IID DIID_Point;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("3C591B21-1F13-101B-B826-00DD01103DE1")
    ...
    interface Point
    {
        CONST_VTBL struct PointVtbl __RPC_FAR *lpVtbl;
    };
...
#endif 	/* __Point_DISPINTERFACE_DEFINED__ */
