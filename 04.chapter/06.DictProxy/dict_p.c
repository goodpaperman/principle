...
/* Object interface: IDictionary, ver. 0.0,
   GUID={0x001A7733,0xAD05,0x4009,{0xBF,0x22,0x79,0x8B,0xA9,0xD5,0x20,0x36}} */
...
/* Object interface: ISpellCheck, ver. 0.0,
   GUID={0x20A839D6,0x125D,0x43a4,{0xBA,0x89,0x09,0xDB,0x67,0x69,0xDD,0xD9}} */
...
const CInterfaceProxyVtbl * _dict_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _dict_StubVtblList[] = 
{
...
PCInterfaceName const _dict_InterfaceNamesList[] = 
{
    "IDictionary",
    "ISpellCheck",
    0
...
#define _dict_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _dict, pIID, n)

int __stdcall _dict_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _dict, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _dict, 2, *pIndex )
    
}

const ExtendedProxyFileInfo dict_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _dict_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _dict_StubVtblList,
    (const PCInterfaceName * ) & _dict_InterfaceNamesList,
    0, // no delegation
    & _dict_IID_Lookup, 
    2,
    1,
